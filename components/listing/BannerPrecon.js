...
export default function BannerPrecon({
  ...
  return (
    <section className="relative w-full bg-gradient-to-r from-blue-50 via-white to-pink-50 py-16">
      {/* Background Elements */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <Button
              ...
              className="bg-red-600 text-white font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105 hover:bg-red-700 uppercase tracking-wider shadow-xl border-2 border-red-600"
            >
              Get First Access
            </Button>
