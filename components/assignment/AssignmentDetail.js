...
import SidebarContact from "../listing/SidebarContact";
import MapGoogle from "../resale/MapGoogle";
import WalkScore from "../resale/WalkScore";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-12">
            ...
            <MapGoogle location={assignment.address} />
          </div>
